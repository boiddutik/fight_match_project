...
//         });
//         await gym.save();
//         await User.findOne({ user: userId });
...
//             const profile = await User.findOne({ user: gym.owner._id });
...
//             role
//         });
//         let userProfile = await User.findOne({ user: userId });
//         if (!userProfile) {
...
//         await gym.save();
//         const userProfile = await User.findOne({ user: userId });
//         if (!userProfile) {
